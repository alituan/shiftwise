# ShiftWise Flutter — Project Index
...
ShiftWise: cross-platform (iOS/Android, Flutter) app answering three questions for hourly workers — next shift, scheduled hours, estimated gross pay. AI-assisted schedule import via photo, always human-confirmed before becoming authoritative.
...
3. The client (Flutter app) never writes entitlements, quota, or billing state. Server-authoritative only, enforced by Firestore rules + Cloud Functions. → `docs/architecture/billing.md`, `docs/threat-model.md`
